...
const SignUp = () => {
  ...
  useEffect(() => {
    if (error && error !== null && error !== "") alert(error);
  }, [error]);
              ...
              <div className="w-full">
                <div className="w-full text-[#111827]">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full text-base h-[55px]  flex justify-center gap-2 items-center p-[11px] text-center bg-[#9013FE] text-white  font-medium border-none transition-colors ease-linear duration-[.2s] rounded-[100px] hover:bg-[#6D28D9] disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                  >
                    Sign up Account
                  </button>
                </div>
                ...
                <button
                  ...
                  disabled={isLogginIn}
                  className="border py-[11px] px-[14px] text-sm w-full gap-2 text-[#111827] border-[#EDE9FE] rounded-md hover:bg-[#F5F3FF] disabled:opacity-70 disabled:cursor-not-allowed transition-all flex items-center justify-center relative"
                >
                  {isLogginIn ? (
