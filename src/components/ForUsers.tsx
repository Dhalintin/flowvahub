  ...
  return (
    <>
      <div className="opacity-100 transform-none">
        <h1 className="text-[40px] font-bold md:text-[72px] mt-[35px] md:mt-[100px] text-center font-[Impact] leading-[120%] px-12">
          YOUR{" "}
                ...
                >
                  {[...testimonials, ...testimonials].map(
                    (testimonial, index) => (
                      ...
                      >
                        <div
                          className={`h-[590px] p-8 rounded-3xl shadow-xl flex flex-col justify-between ${testimonial.color}`}
                        >
      ...
      <section className="flex justify-center px-[14px] mb-5">
